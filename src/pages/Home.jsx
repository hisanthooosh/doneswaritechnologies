      ...
      <section className="py-32 px-4 relative">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-green-600/20 rounded-full blur-[80px] group-hover:bg-green-600/30 transition"></div>
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-bold mb-4">DT Skills</h3>

                <p className="text-slate-400 mb-8 leading-relaxed">
                  An industry-focused training platform that transforms students from beginners to job-ready professionals with
                  structured learning, practical tasks, and an AICTE-approved internship opportunity.
                </p>

                <ul className="space-y-4 mb-8">
                  <li className="flex items-center text-slate-300">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                    Structured Beginner → Advanced Training
                  </li>
                  <li className="flex items-center text-slate-300">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                ...
                <a
                  ...
                  className="text-green-400 font-bold hover:text-white transition flex items-center"
                >
