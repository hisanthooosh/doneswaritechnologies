...
import { FileText, Compass, CheckCircle, Zap, Layout, Globe, Server, Database, ArrowRight, Code } from 'lucide-react';
    ...
    <div className="bg-slate-900 text-white min-h-screen overflow-hidden selection:bg-pink-500 selection:text-white">
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            {/* Background Glow */}
            <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-green-600/10 rounded-full blur-[100px] -z-10 group-hover:bg-green-600/20 transition duration-700"></div>

            {/* Content Side */}
            <div>
              <div className="w-16 h-16 bg-green-600 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-green-500/30">
                <Code className="w-8 h-8 text-white" />
              </div>

              <h2 className="text-4xl font-bold mb-4">DT Skills</h2>
              <p className="text-green-400 text-sm font-bold uppercase tracking-widest mb-6">
                ACTIVE PLATFORM • INDUSTRY TRAINING
              </p>

              <p className="text-slate-300 text-lg mb-8 leading-relaxed">
                A structured, industry-focused learning platform that helps students move from beginner to advanced level
                with real-world tasks, project-based training, and AICTE-approved internship certification.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-white">Beginner → Advanced Roadmap</h4>
                    <p className="text-slate-400 text-sm">Step-by-step guided technical learning.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-4 shrink-0" />
                  <div>
                    <h4 className="font-bold text-white">AICTE Internship Certificate</h4>
                    <p className="text-slate-400 text-sm">Government-recognized internship opportunity after completion.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <CheckCircle className="w-6 h-6 text-green-500 mr-4 shrink-0" />
                  <div>
                    <h4 className="font-bold text-white">Affordable ₹200 Model</h4>
                    <p className="text-slate-400 text-sm">Accessible pricing for Tier-2 & Tier-3 students.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <a
                  href="https://dtskills.tech"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-3 bg-green-600 rounded-full font-bold hover:bg-green-500 transition flex items-center"
                >
            ...
            <div className="relative h-full min-h-[400px] bg-slate-900 rounded-2xl border border-white/10 p-6 flex flex-col justify-center">
              <motion.div
                ...
                className="bg-green-900/20 p-6 rounded-xl border border-green-500/30 text-center"
              >
                <Code className="w-16 h-16 text-green-400 mx-auto mb-4" />
                <h4 className="text-xl font-bold text-green-100">Industry Training</h4>
                <p className="text-green-300/60 text-sm">Skill + Internship + Certification</p>
              </motion.div>
            </div>
