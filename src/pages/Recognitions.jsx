...
import { ShieldCheck, Building2, FileText, CheckCircle, Scale, Landmark, Award, GraduationCap } from 'lucide-react';
    ...
    <div className="bg-slate-900 text-white min-h-screen overflow-hidden selection:bg-blue-500 selection:text-white">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-5xl">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl p-1 border border-white/10 shadow-2xl relative overflow-hidden"
          >
            <div className="bg-slate-900/90 rounded-[22px] p-8 md:p-16 relative z-10">
              <div className="grid md:grid-cols-2 gap-12 items-center">

                <div>
                  <div className="w-20 h-20 bg-yellow-600 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-yellow-500/30">
                    <Award className="w-10 h-10 text-white" />
                  </div>
                  <h2 className="text-3xl font-bold mb-2">DPIIT Recognition</h2>
                  <p className="text-yellow-400 font-medium mb-6">Startup India Initiative</p>

                  <div className="flex items-center p-4 bg-slate-800 rounded-xl border border-white/5">
                    <CheckCircle className="w-6 h-6 text-green-500 mr-4" />
                    <div>
                      <p className="text-xs text-slate-400 uppercase tracking-wide">Status</p>
                      <p className="font-bold text-lg">Recognized Startup</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-800/50 rounded-2xl p-8 border border-white/5">
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed">
                    DPIIT recognition validates our innovation, eligibility for government benefits,
                    tax exemptions, and access to national startup programs.
                  </p>
                </div>
          ...
          >
            <div className="bg-slate-900/90 rounded-[22px] p-8 md:p-16 relative z-10">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <div className="w-20 h-20 bg-green-600 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-green-500/30">
                    <Building2 className="w-10 h-10 text-white" />
                  </div>
                  <h2 className="text-3xl font-bold mb-2">MSME Registration</h2>
                  <p className="text-green-400 font-medium mb-6">Government of India</p>

                  <div className="flex items-center p-4 bg-slate-800 rounded-xl border border-white/5">
                    <CheckCircle className="w-6 h-6 text-green-500 mr-4" />
                    <div>
                      <p className="text-xs text-slate-400 uppercase tracking-wide">Status</p>
                      <p className="font-bold text-lg">Udyam Registered</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-800/50 rounded-2xl p-8 border border-white/5">
                  <h3 className="text-xl font-bold mb-4">Why It Matters</h3>
                  <p className="text-slate-300 text-sm leading-relaxed">
                    MSME registration strengthens our credibility, provides priority sector recognition,
                    and enables us to scale with government-backed benefits.
                  </p>
                </div>
          ...
          >
            <div className="bg-slate-900/90 rounded-[22px] p-8 md:p-16 relative z-10">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                  <div className="w-20 h-20 bg-purple-600 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-purple-500/30">
                    <GraduationCap className="w-10 h-10 text-white" />
                  </div>
                  <h2 className="text-3xl font-bold mb-2">AICTE Internship Approval</h2>
                  <p className="text-purple-400 font-medium mb-6">All India Council for Technical Education</p>

                  <div className="flex items-center p-4 bg-slate-800 rounded-xl border border-white/5">
                    <CheckCircle className="w-6 h-6 text-green-500 mr-4" />
                    <div>
                      <p className="text-xs text-slate-400 uppercase tracking-wide">Status</p>
                      <p className="font-bold text-lg">Approved Internship Provider</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-800/50 rounded-2xl p-8 border border-white/5">
                  <h3 className="text-xl font-bold mb-4">Why It Matters</h3>
                  <p className="text-slate-300 text-sm leading-relaxed">
                    AICTE approval ensures that our internship programs meet national education standards,
                    giving students government-recognized certification.
                  </p>
                </div>
      ...
      <section className="py-20 px-4 bg-black/20 text-center">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-2xl font-bold mb-10 text-slate-400">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12">
            ...
            <div className="hidden md:block w-16 h-1 bg-green-500 rounded"></div>
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="font-bold text-white">MSME</h4>
              <p className="text-xs text-green-400 font-bold uppercase mt-1">Completed</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="font-bold text-white">DPIIT</h4>
              <p className="text-xs text-green-400 font-bold uppercase mt-1">Completed</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="font-bold text-white">AICTE</h4>
              <p className="text-xs text-green-400 font-bold uppercase mt-1">Completed</p>
            </div>
